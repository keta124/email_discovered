# Change these
server '103.216.122.109', port: 1123, roles: [:web, :app, :db], primary: true

set :repo_url,        'git@github.com:nguyenducgiang/coin-notification.git'
set :application,     'coin-notification'
set :user,            'deploy'
...
set :puma_bind,       "unix://#{shared_path}/tmp/sockets/cpn.sock"
...
set :sidekiq_user, fetch(:user) #user to run sidekiq as
